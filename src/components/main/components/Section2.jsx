  ...
  return (
    <div>
      ...
      <div className="flex justify-between mx-20 items-center space-x-5 border-b py-20">
        <div>IMAGE</div>
        <div className="w-1/2">
          <h3 className="text-2xl text-orange-400 font-medium">
            Conquest of Torana
          </h3>
          ...
          Sultan of Bijapur was getting panic and he put Shahji, Shivaji&apos;s
          father in prison. In AD 1659, Shivaji again tried to attack Bijapur
          then the Sultan of Bijapur sent his general, Afzal Khan, to capture
          Shivaji. But Shivaji managed to escape and killed him with a deadly
          weapon called Baghnakh or the tiger&apos;s claw. Finally, in 1662, the
      ...
      <div className="flex justify-between mx-20 items-center space-x-5 border-b py-20">
        ...
        <div className="w-1/2">
          ...
          Malusare, a commander of Maratha ruler Shivaji and Udaybhan Rathod,
          fort keeper under Jai Singh I.
        </div>
      </div>
      ...
      <div className="flex justify-between mx-20 items-center space-x-5 border-b py-20">
        ...
        <div className="w-1/2">
          ...
          coronation symbolises the rise of people who challenges the legacy of
          the Mughal’s. After the coronation, he gets the title of ‘Haidava
          Dharmodharka’ (Protector of Hindu faith) of the newly formed state of
          Hindavi Swarajya. This coronation gives a legitimate right to collect
          land revenue and levy tax on the people.
        </div>
      </div>
      ...
      <div className="flex justify-between mx-20 items-center space-x-5 border-b py-20">
        ...
        <div className="w-1/2">
          ...
          Karanataka (AD 1676-79) and conquered Gingee (Jingi), Vellore and many
          forts in Karnataka.
        </div>
      </div>
    </div>
